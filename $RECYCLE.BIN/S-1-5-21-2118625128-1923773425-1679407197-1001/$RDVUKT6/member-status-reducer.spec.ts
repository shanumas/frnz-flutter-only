...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEMBERSTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_MEMBERSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEMBERSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEMBERSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEMBERSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEMBERSTATUS actions', async () => {
      const expectedActions = [
        {
