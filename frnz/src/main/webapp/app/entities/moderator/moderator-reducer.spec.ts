...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './moderator.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MODERATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_MODERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MODERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MODERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MODERATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MODERATOR actions', async () => {
      const expectedActions = [
        {
