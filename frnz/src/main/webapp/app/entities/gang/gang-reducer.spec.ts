...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gang.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GANG_LIST actions', async () => {
    ...
    it('dispatches FETCH_GANG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GANG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GANG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GANG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GANG actions', async () => {
      const expectedActions = [
        {
