...
/**
 * REST controller for managing {@link frnz.domain.Member}.
 */
@RestController
@RequestMapping("/api")
public class MemberResource {
    ...
    public ResponseEntity<Member> updateMember(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, member.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Member> partialUpdateMember(
        ...
        Optional<Member> result = memberRepository
            ...
            .map(existingMember -> {
                ...
                if (member.getGuest() != null) {
                    existingMember.setGuest(member.getGuest());
                }
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, member.getId()));
    }
